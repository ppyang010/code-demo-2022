...
public class WebClientDemo {
    ...
    public void testPostRESTClient() throws InterruptedException {
        ...
        Flux<String> createdUser = client.post() // 2 使用post方法来创建一个 POST 请求
                ...
                .bodyToFlux(String.class); // 7 WebClient.ResponseSpec的bodyToFlux方法把响应内容转换成User对象，最终得到的结果是Flux<User>
